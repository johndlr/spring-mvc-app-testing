...
//		MockitoAnnotations.initMocks(this);
	...
	public void getStudentsHttpRequest () throws Exception {
		...
		Assertions.assertEquals("Roby", studentCreateServiceMock.getGradebook().getStudents().get(0).getLastname(), "Id should be 1");
		Assertions.assertEquals("Chad", studentCreateServiceMock.getGradebook().getStudents().get(1).getFirstname(), "Firstname Chad");
